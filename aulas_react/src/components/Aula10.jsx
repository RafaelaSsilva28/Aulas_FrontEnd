...
const Aula10 = () => {
    const [contador, setContador] = useState(0) //setando um contador criação de uma variavel
...
//o useEffect fica "monitorando" uma variavel e executa a função sempre que ela sofrer uma alteração
    ...
    useEffect( () => {  //ESSE USEEFECCT FAZ APARECER NA BARRA DO SITE 
        console.log(contador);   //variavel sempre que clicada sofre uma alteração sofre alguma coisa
        document.title = `Contagem: ${contador}` //observando a variavel contador
    }, [contador] )
